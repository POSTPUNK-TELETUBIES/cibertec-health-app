      ...
      <Box sx={{ maxWidth: '1500px', width: '100%', textAlign: 'center', mb: 4 }}>
        ...
        >
          <Typography align='center' variant='h2'>
            Empezar{' '}
            <Typography color='sheldon' fontSize='inherit' fontWeight='inherit' component='span'>
              con HaiDoc
            </Typography>
          </Typography>
          <Typography
          ...
          >
            ...
            urna sem vitae. Viverra facilisis rhoncus et, nibh nullam vitae laoreet.
          </Typography>
          <Button
            variant='contained'
            sx={{ mt: 4, borderRadius: '40px' }}
